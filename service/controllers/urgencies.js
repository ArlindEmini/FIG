...
export default class UrgencyService {
  static get = async (id) => {
    const urgencies = await database.query(getUrgencyById, {
      replacements: {
        id,
      },
  ...
  static update = async (id, body, existingUrgency) => {
    await database.query(updateUrgencyQuery, {
      replacements: {
        id,
        urgency_description:
          body.urgency_description || existingUrgency.urgency_description,
  ...
  static delete = async (id) => {
    return await database.query(deleteUrgency, {
      replacements: {
        id,
      },
  ...
  static checkIn = async (urgencyId) => {
    await database.query(passCheckInUregency, {
      replacements: {
        urgencyId: urgencyId,
      },
      type: QueryTypes.INSERT,
